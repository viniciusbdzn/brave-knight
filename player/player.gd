...
func damage(amount: int) -> void:
	...
	health -= amount
	print("O Player recebeu dano de: ", amount, ".A vida total é de: ", health, "/", max_health)
...
func heal(amount: int) -> int:
	...
	if health > max_health:
		health = max_health
	print("O Player recebeu cura de: ", amount, ".A vida total é de: ", health, "/", max_health)
	return health
